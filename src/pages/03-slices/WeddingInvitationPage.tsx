...
export const WeddingInvitationPage = () => {
	...
	const eventYYYMMDD = useWeddingBoundStore(
		useShallow((state) => state.eventYYYYMMDD()),
	);

	const eventHHMM = useWeddingBoundStore(
		useShallow((state) => state.eventHHMM()),
	);
